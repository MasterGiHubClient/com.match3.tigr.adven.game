...
public class ToggleBehaviour_TLGRadventure : MonoBehaviour
{
    public UnityEvent<bool> on_TLGRadventure, off_TLGRadventure, toggle_TLGRadventure;


    public bool value_TLGRadventure;
    ...
    public void Toggle_TLGRadventure()
    {
        value_TLGRadventure = !value_TLGRadventure;
        ValueChanged_TLGRadventure();
        //<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
    ...
    public bool GetValue_TLGRadventure()
    {
        return value_TLGRadventure;
        //<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        bool run_alreatoryLogic = false;
        if (run_alreatoryLogic)
        {
    ...
    public void SetValue_TLGRadventure(bool value)
    {
        this.value_TLGRadventure = value;
        ValueChanged_TLGRadventure();
    ...
    private void ValueChanged_TLGRadventure()
    {
        if (value_TLGRadventure)
        {
            on_TLGRadventure.Invoke(value_TLGRadventure);
        }
        else
        {
            off_TLGRadventure.Invoke(value_TLGRadventure);
        }
        toggle_TLGRadventure?.Invoke(value_TLGRadventure);
