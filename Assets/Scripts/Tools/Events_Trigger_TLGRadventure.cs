...
public class Events_Trigger_TLGRadventure : MonoBehaviour
{
    //[FormerlySerializedAs("onStart_UrbanEnigma")]
    public UnityEvent onStart_TLGRadventure;
    //[FormerlySerializedAs("onAwake_UrbanEnigma")]
    public UnityEvent onAwake_TLGRadventure;
    //[FormerlySerializedAs("onEnable_UrbanEnigma")]
    public UnityEvent onEnable_TLGRadventure;
    //[FormerlySerializedAs("onDisable_UrbanEnigma")]
    public UnityEvent onDisable_TLGRadventure;
    ...
    {
        onDisable_TLGRadventure?.Invoke();
        //<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        bool run_alreatoryLogic = false;
        if (run_alreatoryLogic)
        {
