...
public class TextSynchronizer_TLGRadventure : MonoBehaviour
{
    public TMP_Text sourceText_TLGRadventure;
    public TMP_Text targetText_TLGRadventure;
    ...
    public void SynchronizeText_TLGRadventure()
    {

        targetText_TLGRadventure.text = sourceText_TLGRadventure.text;
