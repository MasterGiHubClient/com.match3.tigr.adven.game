...
public class InvokerEventDelay_TLGRadventure : MonoBehaviour
{
    [SerializeField] private float seconds_TLGRadventure;
    ...
    public async void TriggerEvent_TLGRadventure()
    {
        await Task.Delay(TimeSpan.FromSeconds(seconds_TLGRadventure));
