...
public class Policy_TLGRadventure : MonoBehaviour
{
    public UnityEvent onPolicyAccepted_TLGRadventure, onPolicyNotAccepted_TLGRadventure;
    ...
    public void CheckIfPolicyAccepted_TLGRadventure()
    {
        if (PlayerPrefs.HasKey("Policy"))
        {
            if (PlayerPrefs.GetInt("Policy") == 1)
            {
                onPolicyAccepted_TLGRadventure?.Invoke();
            }
            else
            {
                onPolicyNotAccepted_TLGRadventure?.Invoke();
            }
        }
        else
        {
    ...
    public void OnClickAccept_TLGRadventure()
    {
