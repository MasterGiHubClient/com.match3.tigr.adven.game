...
public class Loading_TLGRadventure : MonoBehaviour
{
    [SerializeField] private Slider loading_TLGRadventure;
    [SerializeField] private UnityEvent onFinish_TLGRadventure;
    [SerializeField] public float duration_TLGRadventure = 4f;
    ...
    public void TriggerLoading_TLGRadventure()
    {

        loading_TLGRadventure.DOValue(1, duration_TLGRadventure).OnComplete(() =>
        {
            onFinish_TLGRadventure?.Invoke();
        });
