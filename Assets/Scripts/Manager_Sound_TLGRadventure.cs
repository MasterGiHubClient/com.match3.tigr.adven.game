...
public class Manager_Sound_TLGRadventure : MonoBehaviour
{
    [SerializeField] private AudioMixer mixer_TLGRadventure;
    ...
    public void SetVolumeMusic_TLGRadventure(float volume)
    {
        mixer_TLGRadventure.SetFloat("Music", volume <= 0.0001f ? -80f : Mathf.Log10(Mathf.Max(0.0001f, volume)) * 20);
    ...
    public void SetVolumeSFX_TLGRadventure(float volume)
    {
        mixer_TLGRadventure.SetFloat("Sound", volume <= 0.0001f ? -80f : Mathf.Log10(Mathf.Max(0.0001f, volume)) * 20);
